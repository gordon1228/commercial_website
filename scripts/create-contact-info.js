...
async function createContactInfoTable() {
  try {
    ...
    console.log('✓ Default contact info data inserted!')
    
    // Test the API by trying to fetch contact info
    const contactInfo = await prisma.contactInfo.findFirst()
    console.log('✓ Database query test successful:', contactInfo ? 'Contact info found' : 'No contact info found')
