...
CREATE TABLE IF NOT EXISTS public.technology_content (
...
CREATE INDEX IF NOT EXISTS idx_technology_features_order_active ON public.technology_features("order", active);
