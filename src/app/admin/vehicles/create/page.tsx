...
export default function CreateVehiclePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert(`Failed to create truck: ${error}`)
    } finally {
      setIsLoading(false)
    }
  }
  ...
  return (
    <div className="px-6">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Create New Truck</h1>
          <p className="text-gray-600 mt-2">
            Add a new truck to your fleet inventory.
          </p>
        </div>
      </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Describe the truck features and condition..."
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="text-xs text-gray-500">
                  Mark this truck to appear in the featured trucks section on the homepage
                </div>
              </div>
            </CardContent>
          </Card>
              ...
              {activeSpecTab === 'performance' && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input
                      value={formData.specs.displacement}
              ...
              {activeSpecTab === 'interior' && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input
                      value={formData.specs.cabinSpace}
                  ...
                  <div>
                    ...
                    <Input
                      value={formData.specs.airConditioning}
                  ...
                  <div>
                    ...
                    <Input
                      value={formData.specs.upholstery}
                  ...
                  <div>
                    ...
                    <Input
                      value={formData.specs.dashboard}
                  ...
                  <div>
                    ...
                    <Input
                      value={formData.specs.infotainment}
              ...
              {activeSpecTab === 'safety' && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input
                      value={formData.specs.seatbelts}
                  ...
                  <div>
                    ...
                    <Input
                      value={formData.specs.crumpleZones}
                  ...
                  <div>
                    ...
                    <Input
                      value={formData.specs.reinforcement}
                  ...
                  <div>
                    ...
                    <Input
                      value={formData.specs.safetyRating}
                  ...
                  <div>
                    ...
                    <Input
                      value={formData.specs.compliance}
